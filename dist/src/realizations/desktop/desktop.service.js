...
let DesktopService = class DesktopService {
    ...
    async getInstaller() {
        ...
        try {
            ...
            throw new common_1.InternalServerErrorException('No such desktop app installer');
        }
        const fileBuffer = await promises_1.default.readFile(desktopAppPath);
        return fileBuffer;
    }
    async findOne(id) {
        return `This action returns a #${id} desktop`;
    }
    async update(id, updateDesktopDto) {
