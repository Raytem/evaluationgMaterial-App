...
let WaterproofFunctionService = class WaterproofFunctionService {
    constructor(waterProofFunctionRepository) {
        this.waterProofFunctionRepository = waterProofFunctionRepository;
    }
    async create(createWaterproofFunctionDto, manager) {
        if (manager) {
...
exports.WaterproofFunctionService = WaterproofFunctionService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(waterproof_function_entity_1.WaterproofFunctionEntity)),
