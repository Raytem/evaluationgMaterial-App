...
export class ExelService {
  ...
  private fillReliabilitySheet(
    ...
    reliabilitySheet
      .cell('B8')
      .value(
        reliabilityFunction.relativeBlottingPressureAfterLoad_experimental_1,
      );
    reliabilitySheet
      .cell('B9')
      .value(
        reliabilityFunction.relativeWaterResistanceAfterLoad_experimental_1,
      );
    reliabilitySheet
      .cell('B10')
    ...
    reliabilitySheet
      .cell('B11')
      .value(
        reliabilityFunction.waterproofRealizationCriteriaAfterLoad_experimental_1,
      );
    reliabilitySheet
      .cell('B12')
    ...
    reliabilitySheet
      .cell('C11')
      .value(
        reliabilityFunction.waterproofRealizationCriteriaAfterLoad_experimental_2,
      );
    reliabilitySheet
      .cell('C12')
    ...
    reliabilitySheet
      .cell('F11')
      .value(
        reliabilityFunction.waterproofRealizationCriteriaAfterLoad_calculated,
      );
    reliabilitySheet
      .cell('F12')
    ...
    const stretchingCompression =
      `${material.condition?.stretchingCompression}%` || '-';
    ...
    reliabilitySheet
      .cell('H8')
      .value(
        reliabilityFunction.relativeBlottingPressureAfterLoad_relativeValuation,
      );
    reliabilitySheet
      .cell('H9')
      .value(
        reliabilityFunction.relativeWaterResistanceAfterLoad_relativeValuation,
      );
    reliabilitySheet
      .cell('H10')
      .value(
        reliabilityFunction.relativeBlottingTimeAfterLoad_relativeValuation,
      );
    reliabilitySheet
      .cell('H11')
      .value(
        reliabilityFunction.waterproofRealizationCriteriaAfterLoad_relativeValuation,
      );
    reliabilitySheet
      .cell('H12')
    ...
    let washingStr;
    if (washing) {
      washingStr = `${washing.cyclesCnt} циклов, ${washing.washingType.name}, ${
        washing.temperature
      } °C, ${washing.duration} мин, ${
        washing.press ? 'c отжимом' : 'без отжима'
      }`;
    } else {
      washingStr = '-';
    }
